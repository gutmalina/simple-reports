...
const Cabinet = () => {
  ...
  const columns = [
    { field: 'name', headerName: 'Отчет', width: 392 },
          ...
          <div className={styles.table_container}>
            <table className={styles.table}>
              <thead className={styles.table_head}>
                <tr>
                  <th className={styles.table_first_column}>Отчет</th>
                  <th className={styles.table_second_column}>Статус</th>
                  <th className={styles.table_third_column}>
                    Дата формирования
                  </th>
