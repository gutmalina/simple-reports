...
export const TEXT_SIGN_UP = 'РЕГИСТРАЦИЯ';
...
export const TYPE_INPUT_NAME = 'name';
...
export const CARD_INFO_LEAD = [
  {
    _id: 1,
    title: 'Гибкая настройка отчётов',
    subtitle: 'добавляйте в отчёты собственные метрики со значимыми для вас бизнес-показателями'
  },
  {
    _id: 2,
    title: 'Контроль выполнения планов',
    subtitle: 'выполнение медиапланов, контроль недокрутов и перекрутов — ваши бюджеты как на ладони'
  }
]

export const CARD_ADVERTISING = [
  {
    _id: 1,
    company: 'ВКонтакте',
    company_id: 13159
